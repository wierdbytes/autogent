...
export interface AgentSessionHandle {
  ...
  /**
   * Full effective system prompt (SDK `AgentSession.systemPrompt`), which
   * "includes any per-turn extension modifications" — not just the owner's
   * appended text. Undefined when the underlying session does not expose it.
   */
